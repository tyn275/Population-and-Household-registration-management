...
INSERT INTO `phan_anh` VALUES (1,'2025-12-06 03:25:38','Vệ sinh môi trường','Rác thải sinh hoạt ùn ứ tại đầu ngõ 15 chưa được thu gom 2 ngày nay, bốc mùi hôi thối ảnh hưởng đến các hộ xung quanh.','Đang xử lý',NULL,5),(2,'2025-12-06 01:25:38','An ninh trật tự','Đề nghị công an phường kiểm tra nhóm thanh niên hay tụ tập gây ồn ào tại công viên khu dân cư sau 23h đêm.','Đã xử lý',NULL,12),(3,'2025-12-05 03:25:38','Cơ sở hạ tầng','Nắp cống thoát nước trước cửa nhà số 20 bị vỡ, rất nguy hiểm cho người đi đường và trẻ nhỏ.','Đang xử lý','Đã tiếp nhận thông tin, đang chuyển sang bộ phận quản lý đô thị để kiểm tra.',34),(4,'2025-12-03 03:25:38','Tiếng ồn','Hộ gia đình ông B thường xuyên hát Karaoke âm lượng lớn vào giờ nghỉ trưa (12h-13h30), đã nhắc nhở nhưng không khắc phục.','Đang xử lý','Tổ dân phố đang tiến hành xuống tận nơi để nhắc nhở và lập biên bản nếu tái phạm.',48),(5,'2025-12-01 03:25:38','Thủ tục hành chính','Tôi muốn phản ánh về thái độ phục vụ của cán bộ tại bộ phận một cửa sáng thứ 2 vừa rồi, hướng dẫn không rõ ràng.','Đã xử lý','Lãnh đạo phường đã làm việc với cán bộ liên quan để chấn chỉnh thái độ phục vụ. Xin lỗi công dân về sự bất tiện này.',7),(6,'2025-12-06 03:25:38','Trật tự xây dựng','Nhà số 88 đang sửa chữa nhưng để vật liệu cát sỏi tràn lan ra lòng đường cản trở giao thông.','Đang xử lý',NULL,22),(7,'2025-12-05 15:25:38','Phòng cháy chữa cháy','Hộp chữa cháy ở cầu thang bộ khu B bị hỏng khoá, đề nghị ban quản lý kiểm tra lại.','Đã xử lý',NULL,41),(8,'2025-12-04 03:25:38','Cây xanh','Cây phượng vĩ trước cửa nhà văn hóa có cành lớn bị sâu mục, nguy cơ gãy đổ khi mưa bão.','Đang xử lý','Đội cây xanh đang lên lịch cắt tỉa trong chiều nay.',15),(9,'2025-11-29 03:25:38','An ninh trật tự','Có hiện tượng mất trộm vặt (mũ bảo hiểm, chậu cây) tại khu vực để xe chung.','Đã xử lý','Đã tăng cường camera giám sát và cử bảo vệ tuần tra thường xuyên hơn.',30),(10,'2025-12-02 03:25:38','Y tế dự phòng','Khu vực cống rãnh sau dãy nhà C có nhiều muỗi, đề nghị phun thuốc diệt muỗi phòng sốt xuất huyết.','Đang xử lý','Đang tổng hợp danh sách các điểm nóng để lên lịch phun thuốc toàn phường.',3);
